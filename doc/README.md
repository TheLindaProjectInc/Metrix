...
Running
---------------------
The following are some helpful notes on how to run Metrix Core on your native platform.
...
Drag Metrix Core to your applications folder, and then run Metrix Core.
