...
- For `mainnet` -> Take the size of the data directory, excluding `/regtest` and `/testnet1` directories.
- For `testnet` -> Take the size of the `/testnet1` directory.


To calculate `m_assumed_chain_state_size`:
- For `mainnet` -> Take the size of the `/chainstate` directory.
- For `testnet` -> Take the size of the `/testnet1/chainstate` directory.
