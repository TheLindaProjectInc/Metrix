...
2.  Build Metrix Core:
    ...
    Configure and build the headless Metrix Core binaries as well as the GUI (if Qt is found).
...
```shell
mkdir -p "/Users/${USER}/Library/Application Support/Metrix"

touch "/Users/${USER}/Library/Application Support/Metrix/metrix.conf"
...
```shell
tail -f $HOME/Library/Application\ Support/Metrix/debug.log
```
