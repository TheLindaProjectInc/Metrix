...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Metrix address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and metrix: URIs)"));
    ...
    MRCTokenAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_5));
    ...
    connect(MRCTokenAction, SIGNAL(triggered()), this, SLOT(showNormalIfMinimized()));
    connect(MRCTokenAction, SIGNAL(triggered()), this, SLOT(gotoTokenPage()));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Metrix addresses to prove you own them"));
    verifyMessageAction = new QAction(tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Metrix addresses"));
    ...
    openAction->setStatusTip(tr("Open a metrix: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Metrix command-line options").arg(PACKAGE_NAME));
...
void BitcoinGUI::createToolBars()
{
    if(walletFrame)
    {
        ...
        appNavigationBar->addAction(MRCTokenAction);
...
void BitcoinGUI::setClientModel(ClientModel *_clientModel)
{
    ...
    if(_clientModel)
    {
        ...
        if(_clientModel->getOptionsModel()->getCheckForUpdates() && qtumVersionChecker->newVersionAvailable())
        {
            ...
            QString message(tr("New version of Metrix wallet is available on the Metrix source code repository: <br /> %1. <br />It is recommended to download it and update this application").arg(link));
...
void BitcoinGUI::setWalletActionsEnabled(bool enabled)
{
    ...
    MRCTokenAction->setEnabled(enabled);
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        tooltip = tr("%n active connection(s) to Metrix network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
