...
QString BitcoinUnits::longName(int unit)
{
    switch(unit)
    {
    case BTC: return QString("MRX");
    case mBTC: return QString("mMRX");
    case uBTC: return QString::fromUtf8("μMRX (bits)");
...
QString BitcoinUnits::description(int unit)
{
    ...
    {
    case BTC: return QString("MRX");
    case mBTC: return QString("Milli-MRX (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-MRX (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
