...
void WalletInit::AddWalletOptions() const
{
    ...
    gArgs.AddArg("-stakesplitthreshold=<amt>", strprintf("Staking outputs above this threshold (in %s) will be split into two outputs (default: %s)", CURRENCY_UNIT, FormatMoney(DEFAULT_STAKE_SPLIT_THRESHOLD)), ArgsManager::ALLOW_ANY, OptionsCategory::WALLET);
    gArgs.AddArg("-stakecombinethreshold=<amt>", strprintf("Additional inputs below this threshold (in %s) will be combined into a coinstake (default: %s)", CURRENCY_UNIT, FormatMoney(DEFAULT_STAKE_COMBINE_THRESHOLD)), ArgsManager::ALLOW_ANY, OptionsCategory::WALLET);
