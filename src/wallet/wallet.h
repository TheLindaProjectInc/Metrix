...
//! -discardfee default
static const CAmount DEFAULT_DISCARD_FEE = 1000000000;
//! -mintxfee default
static const CAmount DEFAULT_TRANSACTION_MINFEE = 1000000000;
...
constexpr CAmount HIGH_TX_FEE_PER_KB{1000 * DEFAULT_TRANSACTION_MINFEE};
