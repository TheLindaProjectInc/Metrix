...
public:
    explicit CRegTestParams(const ArgsManager& args)
    {
        ...
        consensus.MIP3StartHeight = 5500;
        consensus.MIP3Height = -1;
        consensus.MIP4StartHeight = 6000;
        consensus.MIP4Height = -1;
        consensus.MIP5StartHeight = 7000; // Start checking for MIP5
        consensus.MIP5Height = -1;        // Activation block:
        consensus.MIP6StartHeight = 8000; // Start checking for MIP6
        consensus.MIP6Height = -1;        // Activation block:
