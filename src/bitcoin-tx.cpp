...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " metrix-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  metrix-tx [options] <hex-tx> [commands]  Update hex-encoded metrix transaction\n" +
            "or:     metrix-tx [options] -create [commands]   Create hex-encoded metrix transaction\n" +
            "\n";
