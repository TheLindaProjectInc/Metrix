...
{
    // Call into TxToUniv() in metrix-common to decode the transaction hex.
    //
    // Blockchain contextual information (confirmations and blocktime) is not
    // available to code in metrix-common, so we query them here and push the
                            ...
                            {"contract", RPCArg::Type::OBJ, RPCArg::Optional::OMITTED, "(send to contract)",
                                {
                                    ...
                                    {"amount", RPCArg::Type::AMOUNT,  /* default */ "0", "Value in MRX to send with the call, should be a valid amount, default 0"},
...
static UniValue sendrawtransaction(const JSONRPCRequest& request)
{
    RPCHelpMan{"sendrawtransaction",
                ...
                "\nAlso see createrawtransaction and signrawtransactionwithkey calls.\n",
                {
                    ...
                    {"maxfeerate", RPCArg::Type::AMOUNT, /* default */ FormatMoney(DefaultMaxRawTxFeeRate().GetFeePerK()),
    ...
    CFeeRate max_raw_tx_fee_rate = DefaultMaxRawTxFeeRate();
...
static UniValue testmempoolaccept(const JSONRPCRequest& request)
{
    RPCHelpMan{"testmempoolaccept",
            ...
            "                                        Length must be one for now.",
                    ...
                    {"maxfeerate", RPCArg::Type::AMOUNT, /* default */ FormatMoney(DefaultMaxRawTxFeeRate().GetFeePerK()), "Reject transactions whose fee rate is higher than the specified value, expressed in " + CURRENCY_UNIT + "/kB\n"},
                },
                RPCResult{
...
UniValue decodepsbt(const JSONRPCRequest& request)
{
            RPCHelpMan{"decodepsbt",
                "\nReturn a JSON object representing the serialized, base64-encoded partially signed Metrix transaction.\n",
                {
...
UniValue combinepsbt(const JSONRPCRequest& request)
{
            RPCHelpMan{"combinepsbt",
                "\nCombine multiple partially signed Metrix transactions into one transaction.\n"
