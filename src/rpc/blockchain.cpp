...
UniValue getblockchaininfo(const JSONRPCRequest& request)
{
    ...
    BuriedForkDescPushBack(softforks, "mip1-min", consensusParams.minMIP1Height);
    BuriedForkDescPushBack(softforks, "mip1-ack", consensusParams.MIP1Height);
    BIP9SoftForkDescPushBack(softforks, "mip2-min", consensusParams.minMIP2Height);
    BIP9SoftForkDescPushBack(softforks, "mip2-ack", consensusParams.MIP2Height);
