...
Value getrawtransaction(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "           \"LeuaKA9DmsLNExw14vLMSk1MBBJ4vyrgVG\"        (string) Lindacoin address\n"
            "           ,...\n"
            "         ]\n"
            "       }\n"
            "     }\n"
...
Value listunspent(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 5)
        throw runtime_error(
            ...
            "3. \"addresses\"    (string) A json array of Lindacoin addresses to filter\n"
            "    [\n"
            ...
            "    \"address\" : \"address\",  (string) the Lindacoin address\n"
            ...
            "\nExamples\n" +
            HelpExampleCli("listunspent", "") + HelpExampleCli("listunspent", "6 9999999 \"[\\\"LeuaKA9DmsLNExw14vLMSk1MBBJ4vyrgVG\\\",\\\"LdJQamK9utuhc8trqzgiB21zeMpzS1onMk\\\"]\"") + HelpExampleRpc("listunspent", "6, 9999999 \"[\\\"LeuaKA9DmsLNExw14vLMSk1MBBJ4vyrgVG\\\",\\\"LdJQamK9utuhc8trqzgiB21zeMpzS1onMk\\\"]\""));
    ...
    if (params.size() > 2) {
        ...
        BOOST_FOREACH (Value& input, inputs) {
            ...
            if (!address.IsValid())
                throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, string("Invalid Linda address: ") + input.get_str());
    ...
    pwalletMain->AvailableCoins(vecOutputs, false, NULL, false, ALL_COINS, false, nWatchonlyConfig, bIncludeLocked);
...
Value createrawtransaction(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
        throw runtime_error(
            ...
            "    {\n"
            "      \"address\": x.xxx   (numeric, required) The key is the Lindacoin address, the value is the LINDA amount\n"
            "      ,...\n"
            "    }\n"
...
Value decoderawtransaction(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "  \"vout\" : [             (array of json objects)\n"
            "     {\n"
            "       \"value\" : x.xxx,            (numeric) The value in LINDA\n"
            "       \"n\" : n,                    (numeric) index\n"
            "       \"scriptPubKey\" : {          (json object)\n"
            "         \"asm\" : \"asm\",          (string) the asm\n"
            "         \"hex\" : \"hex\",          (string) the hex\n"
...
Value searchrawtransactions(const Array& params, bool fHelp)
{
    ...
    throw JSONRPCError(RPC_DATABASE_ERROR, "method deprecated");
