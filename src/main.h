...
static const int64_t MASTERNODE_COLLATERALS[] = { 2000000 * COIN, 5000000 * COIN, 25000000 * COIN, 50000000 * COIN, 100000000 * COIN };
...
//! Start soft-fork v8
static const int V8_START_BLOCK = 990000;
/*
