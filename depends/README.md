...
A prefix will be generated that's suitable for plugging into Metrix's
configure. In the above example, a dir named x86_64-w64-mingw32 will be
created. To use it for Metrix:
...
options will be passed to Metrix's configure. In this case, `--disable-wallet`.
